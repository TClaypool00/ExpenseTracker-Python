...
class RegisterForm(forms.Form):
    ...
    phone_num = forms.IntegerField(widget=TextInput(attrs={'placeholder' : 'Phone Number'}), label=False)
    salary = forms.FloatField(widget=TextInput(attrs={'placeholder' : 'Salary'}), label=False)
